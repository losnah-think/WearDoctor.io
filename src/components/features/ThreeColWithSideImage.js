...
const PrimaryButton = styled(PrimaryButtonBase)`
  ${tw`absolute top-3/4 w-3/4 h-16 bg-white border border-gray-800 lg:text-lg md:text-sm text-xs text-gray-800 inset-y-1/2 -translate-x-1/2 -translate-y-1/2`}
`;
